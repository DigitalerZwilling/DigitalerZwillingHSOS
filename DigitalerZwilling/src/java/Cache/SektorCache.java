...
public class SektorCache extends Cache {
    ...
    public void update() throws DBErrorExeption {
        try {
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_sektor, "
                    + "stoerung, zeitstempel, user_parameter FROM Sektor");
    ...
    public void updateAll() {
        try {
            ...
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_sektor, "
                    + "stoerung, position_x, position_y, position_z, position_ausrichtung, ausrichtung, bezeichnung, zeitstempel, user_parameter FROM Sektor");
            List<String> ids = rsMap.get("ID_SEKTOR");
