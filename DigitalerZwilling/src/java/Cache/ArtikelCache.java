...
public class ArtikelCache extends Cache {
    ...
    public void updateAll() {
        try {
            ...
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_artikel, "
                    + "bezeichnung, zeitstempel, user_parameter FROM Artikel");
            List<String> ids = rsMap.get("ID_ARTIKEL");
    ...
    private List<Long> readWarentraeger(Long id) throws DBNotFoundExeption, QueryExeption {
        ...
        Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_warentraeger "
                + "FROM Artikel_Warentraeger WHERE id_artikel=" + id);
