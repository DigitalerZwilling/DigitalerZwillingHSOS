...
public class HubPodestCache extends Cache {
    ...
    public void update() throws DBErrorExeption {
        ...
        try {
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_hubpodest, "
                    + "oben, unten, zeitstempel, user_parameter FROM hubpodest");
    ...
    public void updateAll() {
        try {
            ...
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_hubpodest, "
                    + "bezeichnung, oben, unten, id_sektor, zeitstempel, user_parameter FROM hubpodest");
            List<String> ids = rsMap.get("ID_HUBPODEST");
