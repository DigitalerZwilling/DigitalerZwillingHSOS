...
public class GelenkCache extends Cache{
    ...
    public void updateAll() {
        ...
        Map<String,List<String>> rsMap= Datenbankschnittstelle.getInstance().datenbankAnfrage("SELECT id_gelenk,bezeichnung,typ,nummer,gelenkstellung,zeitstempel,user_parameter FROM Gelenk");
    ...
    Long readRoboter(Long id){
        Map<String,List<String>> rsMap = Datenbankschnittstelle.getInstance().datenbankAnfrage("SELECT id_roboter FROM Gelenk WHERE id_gelenk="+id+" ");
