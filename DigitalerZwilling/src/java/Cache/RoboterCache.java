...
public class RoboterCache extends Cache {
    ...
    public void update() throws DBErrorExeption {
        ...
        try {
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_roboter, "
                    + "stoerung, position_x, position_y, position_z, position_ausrichtung, zeitstempel, user_parameter FROM Roboter");
    ...
    public void updateAll() {
        try {
            ...
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_roboter, "
                    + "bezeichnung, stoerung, position_x, position_y, position_z, position_ausrichtung, zeitstempel, user_parameter FROM Roboter");
            List<String> ids = rsMap.get("ID_ROBOTER");
