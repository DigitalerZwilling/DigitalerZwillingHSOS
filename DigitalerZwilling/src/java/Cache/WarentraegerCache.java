...
public class WarentraegerCache extends Cache {
    ...
    public void update() throws DBErrorExeption {
        ...
        try {
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_warentraeger, "
                    + "stoerung, zeitstempel, user_parameter, abstand_mm, montagezustand, RFID_inhalt FROM Warentraeger");
    ...
    public void updateAll() {
        try {
            ...
            Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_warentraeger, "
                    + "bezeichnung, stoerung, zeitstempel, user_parameter, abstand_mm, montagezustand, RFID_inhalt FROM Warentraeger");
            List<String> ids = rsMap.get("ID_WARENTRAEGER");
    ...
    private List<Long> readTransportband(Long id) throws DBNotFoundExeption, QueryExeption {
        Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_transportband "
                + "FROM Transportband_Warentraeger WHERE id_warentraeger=" + id);
    ...
    private List<Long> readSektor(Long id) throws DBNotFoundExeption, QueryExeption {
        Map<String, List<String>> rsMap = this.datenbankschnittstelle.datenbankAnfrage("SELECT id_sektor "
                + "FROM Sektor_Transportband WHERE id_warentraeger=" + id);
